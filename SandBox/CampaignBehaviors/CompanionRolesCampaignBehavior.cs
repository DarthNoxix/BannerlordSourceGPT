...
public class CompanionRolesCampaignBehavior : CampaignBehaviorBase
{
	...
	protected void AddDialogs(CampaignGameStarter campaignGameStarter)
	{
		...
		campaignGameStarter.AddDialogLine("companion_fire_farewell", "companion_fire3", "close_window", "{=LrbyNgAa}{AGREE_TO_LEAVE}[ib:nervous2]", companion_agrees_to_leave_on_condition, companion_fire_on_consequence);
	...
	{
		if (Campaign.Current.CurrentConversationContext == ConversationContext.FreedHero && Hero.OneToOneConversationHero?.CompanionOf == Clan.PlayerClan && CharacterObject.OneToOneConversationCharacter.Occupation == Occupation.Wanderer)
		{
	...
	{
		if (Campaign.Current.CurrentConversationContext == ConversationContext.FreedHero && Hero.OneToOneConversationHero?.CompanionOf == Clan.PlayerClan)
		{
