...
public class Crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_21_CraftingPieceGrid__DependendPrefab : Widget
{
		...
		if (_datasource_Root_GuardPieceList != null)
		{
			...
			if (_datasource_Root_GuardPieceList_Pieces != null)
			{
				...
				for (int num = _widget_0_0_0_1_0.ChildCount - 1; num >= 0; num--)
				{
					...
					((Crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_36_ItemTemplate)_widget_0_0_0_1_0.GetChild(num)).DestroyDataSource();
				}
	...
	public void OnList_datasource_Root_GuardPieceList_PiecesChanged(object sender, TaleWorlds.Library.ListChangedEventArgs e)
	{
		...
		case TaleWorlds.Library.ListChangedType.ItemAdded:
		{
			...
			_widget_0_0_0_1_0.AddChildAtIndex(crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_36_ItemTemplate, e.NewIndex);
		...
		if (_datasource_Root_GuardPieceList != null)
		{
			...
			if (_datasource_Root_GuardPieceList_Pieces != null)
			{
				...
				for (int i = 0; i < _datasource_Root_GuardPieceList_Pieces.Count; i++)
				{
					...
					crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_36_ItemTemplate.AddComponent(generatedWidgetData);
					_widget_0_0_0_1_0.AddChildAtIndex(crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_36_ItemTemplate, i);
					crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_36_ItemTemplate.CreateWidgets();
					crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_36_ItemTemplate.SetIds();
					crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_36_ItemTemplate.SetAttributes();
					crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_36_ItemTemplate.SetDataSource(dataSource);
