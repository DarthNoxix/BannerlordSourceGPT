...
public class Crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_25_ItemTemplate : ButtonWidget
{
	...
	public void DestroyDataSource()
	{
		...
		if (_datasource_Root_Yield != null)
		{
			...
			for (int num = _widget_2.ChildCount - 1; num >= 0; num--)
			{
				...
				((Crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_43_ItemTemplate)_widget_2.GetChild(num)).DestroyDataSource();
			}
	...
	public void OnList_datasource_Root_YieldChanged(object sender, TaleWorlds.Library.ListChangedEventArgs e)
	{
		...
		case TaleWorlds.Library.ListChangedType.ItemAdded:
		{
			...
			_widget_2.AddChildAtIndex(crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_43_ItemTemplate, e.NewIndex);
	...
	private void RefreshDataSource_datasource_Root(SmeltingItemVM newDataSource)
	{
		...
		if (_datasource_Root_Yield != null)
		{
			...
			for (int i = 0; i < _datasource_Root_Yield.Count; i++)
			{
				...
				crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_43_ItemTemplate.AddComponent(generatedWidgetData);
				_widget_2.AddChildAtIndex(crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_43_ItemTemplate, i);
				crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_43_ItemTemplate.CreateWidgets();
				crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_43_ItemTemplate.SetIds();
				crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_43_ItemTemplate.SetAttributes();
				crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_43_ItemTemplate.SetDataSource(dataSource);
