...
public class Crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_26_ItemTemplate : ButtonWidget
{
	...
	public void DestroyDataSource()
	{
		...
		if (_datasource_Root_InputMaterials != null)
		{
			...
			for (int num = _widget_0_0.ChildCount - 1; num >= 0; num--)
			{
				...
				((Crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_44_ItemTemplate)_widget_0_0.GetChild(num)).DestroyDataSource();
			}
		...
		if (_datasource_Root_OutputMaterials != null)
		{
			...
			for (int num2 = _widget_0_2.ChildCount - 1; num2 >= 0; num2--)
			{
				...
				((Crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_45_ItemTemplate)_widget_0_2.GetChild(num2)).DestroyDataSource();
			}
	...
	public void OnList_datasource_Root_InputMaterialsChanged(object sender, TaleWorlds.Library.ListChangedEventArgs e)
	{
		...
		case TaleWorlds.Library.ListChangedType.ItemAdded:
		{
			...
			_widget_0_0.AddChildAtIndex(crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_44_ItemTemplate, e.NewIndex);
	...
	public void OnList_datasource_Root_OutputMaterialsChanged(object sender, TaleWorlds.Library.ListChangedEventArgs e)
	{
		...
		case TaleWorlds.Library.ListChangedType.ItemAdded:
		{
			...
			_widget_0_2.AddChildAtIndex(crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_45_ItemTemplate, e.NewIndex);
	...
	private void RefreshDataSource_datasource_Root(RefinementActionItemVM newDataSource)
	{
		...
		if (_datasource_Root_InputMaterials != null)
		{
			...
			for (int i = 0; i < _datasource_Root_InputMaterials.Count; i++)
			{
				...
				crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_44_ItemTemplate.AddComponent(generatedWidgetData);
				_widget_0_0.AddChildAtIndex(crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_44_ItemTemplate, i);
				crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_44_ItemTemplate.CreateWidgets();
				crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_44_ItemTemplate.SetIds();
				crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_44_ItemTemplate.SetAttributes();
				crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_44_ItemTemplate.SetDataSource(dataSource);
		...
		if (_datasource_Root_OutputMaterials != null)
		{
			...
			for (int j = 0; j < _datasource_Root_OutputMaterials.Count; j++)
			{
				...
				_widget_0_2.AddChildAtIndex(crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_45_ItemTemplate, j);
				crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_45_ItemTemplate.CreateWidgets();
				crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_45_ItemTemplate.SetIds();
				crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_45_ItemTemplate.SetAttributes();
				crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_45_ItemTemplate.SetDataSource(dataSource2);
			}
		}
	}
	...
	private void RefreshDataSource_datasource_Root_OutputMaterials(MBBindingList<CraftingResourceItemVM> newDataSource)
	{
		...
		if (_datasource_Root_OutputMaterials != null)
		{
			...
			for (int i = 0; i < _datasource_Root_OutputMaterials.Count; i++)
			{
				...
				crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_45_ItemTemplate.AddComponent(generatedWidgetData);
				_widget_0_2.AddChildAtIndex(crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_45_ItemTemplate, i);
				crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_45_ItemTemplate.CreateWidgets();
				crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_45_ItemTemplate.SetIds();
				crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_45_ItemTemplate.SetAttributes();
				crafting__TaleWorlds_CampaignSystem_ViewModelCollection_WeaponCrafting_CraftingVM_Dependency_45_ItemTemplate.SetDataSource(dataSource);
