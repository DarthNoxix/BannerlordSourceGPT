...
public class SandBoxMissionViews
{
	...
	public static MissionView[] OpenBattleMission(Mission mission)
	{
		...
		obj.Add((MissionView)new MissionDeploymentBoundaryMarker((IEntityFactory)new BorderFlagEntityFactory("swallowtail_banner"), 2f));
	...
	public static MissionView[] OpenSiegeMissionWithDeployment(Mission mission)
	{
		...
		list.Add((MissionView)new MissionDeploymentBoundaryMarker((IEntityFactory)new BorderFlagEntityFactory("swallowtail_banner"), 2f));
