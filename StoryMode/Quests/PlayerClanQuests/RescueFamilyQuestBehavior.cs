...
public class RescueFamilyQuestBehavior : CampaignBehaviorBase
{
	public class RescueFamilyQuest : StoryModeQuestBase
	{
			...
			: base("rescue_your_family_storymode_quest", null, CampaignTime.Never)
		{
			...
			_hideout = SettlementHelper.FindNearestHideout((Settlement s) => !Campaign.Current.BusyHideouts.Contains(s));
		...
		private bool bandit_hideout_boss_fight_start_on_condition()
		{
			...
			if (encounteredParty.IsSettlement && encounteredParty.Settlement.IsHideout && encounteredParty.Settlement == _hideout && Mission.Current != null && Mission.Current.GetMissionBehavior<HideoutMissionController>() != null && Hero.OneToOneConversationHero != null)
			{
